package pe.dcs.app.features.access_user.mapper;

import pe.dcs.app.entity.Credential;
import pe.dcs.app.entity.Person;
import pe.dcs.app.entity.UserAccess;
import pe.dcs.app.features.access_user.response.AccessSummaryResponse;
import pe.dcs.app.features.access_user.response.AccessUserSearchResponse;
...
public class AccessUserMapper {
    ...
    public static AccessUserSearchResponse map(Person user) {
