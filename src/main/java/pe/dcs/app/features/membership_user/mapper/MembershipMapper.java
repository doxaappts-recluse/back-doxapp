package pe.dcs.app.features.membership_user.mapper;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import pe.dcs.app.entity.Membership;
import pe.dcs.app.entity.Person;
import pe.dcs.app.features.membership_user.response.MembershipContextResponse;
import pe.dcs.app.features.membership_user.response.MembershipResponse;
import pe.dcs.app.features.membership_user.response.MembershipUserResponse;
...
public class MembershipMapper {
    ...
    public static MembershipContextResponse toResponseWithUser(Membership membership) {
        ...
        Person user = membership.getPerson();
